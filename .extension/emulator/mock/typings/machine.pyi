...
class Pin:
    ...
    def drive(self, drive: Optional[int] = ...) -> Optional[int]: ...
    def irq(
        self,
...
class I2C:
    ...
    def start(self) -> None: ...
    def stop(self) -> None: ...
    def readinto(self, buf: bytearray, nack: bool = ...) -> None: ...
    def write(self, buf: bytes) -> int: ...
    def writevto(self, addr: int, vector: list, stop: bool = ...) -> int: ...
...
class UART:
    ...
    def flush(self) -> None: ...
    @classmethod
    def enable_loopback(cls, enabled: bool = ...) -> None: ...
...
class RTC:
    ...
    def alarm(self, id: int, time: Optional[tuple] = ..., *, repeat: bool = ...) -> None: ...
    def alarm_left(self, id: int = ...) -> int: ...
    def cancel(self, id: int = ...) -> None: ...
    def irq(self, *, trigger: int = ..., handler: Optional[Callable] = ..., wake: int = ...) -> None: ...
...
def bootloader(timeout: int = ...) -> None:
    """Enter bootloader mode."""
    ...

def time_pulse_us(pin: Pin, pulse_level: int, timeout_us: int = ...) -> int:
    """Time a pulse on a pin in microseconds."""
    ...

def bitstream(pin: Pin, encoding: int, timing: tuple, data: bytes) -> None:
    """Transmit a bitstream on a pin."""
    ...
