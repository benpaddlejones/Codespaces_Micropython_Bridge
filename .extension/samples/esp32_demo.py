...
def demo_digital_read():
    ...
    input_pins = [
        ("GPIO16 (IN)", Pin(16, Pin.IN)),
        ("GPIO17 (PULL_UP)", Pin(17, Pin.IN, Pin.PULL_UP)),
        ("GPIO18 (PULL_DOWN)", Pin(18, Pin.IN, Pin.PULL_DOWN)),
        ("GPIO19 (IN)", Pin(19, Pin.IN)),
        ("GPIO21 (PULL_UP)", Pin(21, Pin.IN, Pin.PULL_UP)),
        ("GPIO22 (PULL_DOWN)", Pin(22, Pin.IN, Pin.PULL_DOWN)),
    ]
